...
v_float32x8 v_setall(const float& val) {
...
void doCalcMinEigenValLine(int& j, int width, const float* cov_x2, const float* cov_xy, const float* cov_y2, float* dst) {
    calcMinEigenValLine<v_float32x8, v_float32x8::nlanes, v_load, v_store, v_setall, v_sqrt>(j, width, cov_x2, cov_xy, cov_y2, dst);
}

void doCalcHarrisLine(int& j, int width, const float* cov_x2, const float* cov_xy, const float* cov_y2, float* dst, double k) {
    calcHarrisLine<v_float32x8, v_float32x8::nlanes, v_load, v_store, v_setall>(j, width, cov_x2, cov_xy, cov_y2, dst, k);
}

void doCornerEigenValsVecsLine(int& j, int width, const float* dxdata, const float* dydata, float* cov_x2, float* cov_xy, float* cov_y2) {
    cornerEigenValsVecsLine<v_float32x8, v_float32x8::nlanes, v_load, v_store>(j, width, dxdata, dydata, cov_x2, cov_xy, cov_y2);
}

#else  // universal intrinsics

void doCalcMinEigenValLine(int& j, int width, const float* cov_x2, const float* cov_xy, const float* cov_y2, float* dst) {
    calcMinEigenValLine<v_float32, v_float32::nlanes, vx_load, v_store, vx_setall, v_sqrt, v_muladd>(j, width, cov_x2, cov_xy, cov_y2, dst);
}

void doCalcHarrisLine(int& j, int width, const float* cov_x2, const float* cov_xy, const float* cov_y2, float* dst, double k) {
    calcHarrisLine<v_float32, v_float32::nlanes, vx_load, v_store, vx_setall>(j, width, cov_x2, cov_xy, cov_y2, dst, k);
}

void doCornerEigenValsVecsLine(int& j, int width, const float* dxdata, const float* dydata, float* cov_x2, float* cov_xy, float* cov_y2) {
    cornerEigenValsVecsLine<v_float32, v_float32::nlanes, vx_load, v_store>(j, width, dxdata, dydata, cov_x2, cov_xy, cov_y2);
}
